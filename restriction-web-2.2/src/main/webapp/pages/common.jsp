        ...
        <%-- <link href="<%=request.getContextPath()%>/resources/css/bootstrap-theme.css" rel="stylesheet"> --%>
          ...
          <link href="<%=request.getContextPath()%>/resources/css/restrictionapp.css" rel="stylesheet">
	...
	<script src="<%=request.getContextPath()%>/resources/js/serverCall.js" type="text/javascript"></script>
